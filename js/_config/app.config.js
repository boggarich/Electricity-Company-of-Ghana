...
var myapp_config = {
  ...
  */
  ...
  // used by pagescrolling and appHeight script, do not change!
  ...
  */
  rippleEffect: true,
  // material design effect that appears on all buttons
  ...
  */
  ...
  //changing this may implicate slimscroll plugin target
  navHooks: $('#js-nav-menu'),
  //changing this may implicate CSS targets
  navAccordion: true,
